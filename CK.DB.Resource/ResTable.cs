...
namespace CK.DB.Resource
{
    ...
    public abstract class ResTable : SqlTable
    {
        ...
        public abstract int Create( string resName );
        ...
        /// <returns>The new resource identifier.</returns>
        [SqlProcedureNonQuery( "sResCreate" )]
        public abstract Task<int> CreateAsync( string resName );
        ...
        public abstract int Assume( string resName );
        ...
        /// <returns>The resource identifier.</returns>
        [SqlProcedureNonQuery( "sResAssume" )]
        public abstract Task<int> AssumeAsync( string resName );
        ...
        public abstract int CreateAuto( string prefix = "R.Auto" );
        ...
        /// <returns>The new resource identifier.</returns>
        [SqlProcedureNonQuery( "sResCreateAuto" )]
        public abstract Task<int> CreateAutoAsync( string prefix = "R.Auto" );
        ...
        public abstract void Destroy( int resId );

        [SqlProcedureNonQuery( "sResDestroyChildren" )]
        public abstract void DestroyChildren( int resId );

        [SqlProcedureNonQuery( "sResDestroyWithChildren" )]
        public abstract void DestroyWithChildren( int resId );

        [SqlProcedureNonQuery( "sResDestroyByPrefix" )]
        public abstract void DestroyByPrefix( string resNamePrefix );

        [SqlProcedureNonQuery( "sResRename" )]
        public abstract void Rename( int resId, string newName, bool withChildren = true );
