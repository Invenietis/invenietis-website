...
namespace CK.DB.Resource
{
    ...
    public abstract class ResStringTable : SqlTable
    {
        ...
        public abstract void StringSet( ISqlCallContext ctx, int resId, short lcid, string value );

        [SqlProcedureNonQuery( "sResStringAssume" )]
        public abstract int StringAssume( ISqlCallContext ctx, string resName, short lcid, string value );

        [SqlProcedureNonQuery( "sResStringRemove" )]
        public abstract void StringRemove( ISqlCallContext ctx, int resId, short lcid );
